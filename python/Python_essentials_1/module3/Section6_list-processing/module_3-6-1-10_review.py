...
# 4. The start and end parameters are optional when 
#performing a slice: list[start:end], e.g.:
...
# 6. You can test if some items exist in a list or 
# not using the keywords in and not in, e.g.:
